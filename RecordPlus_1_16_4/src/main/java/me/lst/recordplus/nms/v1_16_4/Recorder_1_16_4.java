package me.lst.recordplus.nms.v1_16_4;
...
import me.lst.recordplus.util.nms.v1_16_4.DataWatcherUtils;
import me.lst.recordplus.util.nms.v1_16_4.ItemUtils;
import me.lst.recordplus.util.nms.v1_16_4.PacketUtils;
import me.lst.recordplus.util.nms.v1_16_4.Packets;
...
public class Recorder_1_16_4 extends Recorder {
    public Recorder_1_16_4(Plugin plugin, Configuration configuration, RecordingStorage storage) {
    ...
    public void tick(Map<Entity, List<EntityTracker>> trackedEntities) {
        for (Map.Entry<Entity, List<EntityTracker>> entry : trackedEntities.entrySet()) {
            ...
            net.minecraft.server.v1_16_R3.EntityLiving nmsEntity = ((CraftLivingEntity) entity).getHandle();
