...
import me.lst.recordplus.util.nms.v1_16_3.DataWatcherUtils;
import me.lst.recordplus.util.nms.v1_16_3.ItemUtils;
import me.lst.recordplus.util.nms.v1_16_3.PacketUtils;
import me.lst.recordplus.util.nms.v1_16_3.Packets;
...
public class Recorder_1_16_3 extends Recorder {
    public Recorder_1_16_3(Plugin plugin, Configuration configuration, RecordingStorage storage) {
    ...
    public void tick(Map<Entity, List<EntityTracker>> trackedEntities) {
        for (Map.Entry<Entity, List<EntityTracker>> entry : trackedEntities.entrySet()) {
            ...
            net.minecraft.server.v1_16_R2.EntityLiving nmsEntity = ((CraftLivingEntity) entity).getHandle();
